class Aircraft {
  ...
  const Aircraft({required this.id, required this.name, required this.squadron});
}
...
const aircraftList = [
  Aircraft(id: '15-001', name: 'F-15K', squadron: '11전투비행단'),
  Aircraft(id: '16-003', name: 'F-16', squadron: '11전투비행단'),
  Aircraft(id: '15-007', name: 'F-15K', squadron: '11전투비행단'),
];

const hudWriteupGuide = MaintenanceGuide(
  defectCode: '21-31-00 / HUD Symbol Instability',
  summary:
      'HUD 타겟팅 기호 간헐적 흔들림은 HUD 전원 공급 불안정 또는 '
      '심볼 생성기(SCG) 커넥터 접촉 불량 가능성이 높습니다. '
      '과거 유사 사례 3건 중 2건이 커넥터 재체결로 해결되었습니다.',
